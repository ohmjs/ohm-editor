...
(function(root, initModule) {
  ...
  function renderInputText(text, rect, optAlpha) {
    ...
    var baseRect = $('#semanticsContainer').getBoundingClientRect();
    var x = rect.left - baseRect.right;
  ...
  function renderHighlight(el) {
    ...
    var rect = {
      x: (elBounds.left - baseRect.right) * pixelRatio,
      y: 0,
