...
(function(root, initModule) {
  if (typeof exports === 'object') {
    ...
    initModule(root.ohm, root.ohmEditor, root.domUtil, root.CodeMirror);
  }
})(this, function(ohm, ohmEditor, domUtil, CodeMirror) {
  ...
  function createRuleContainer(ruleKey) {
    ...
    container.appendChild(domUtil.createElement('cstNodeName', ruleKey));
  ...
  // wrappers for moving, closing, etc.
